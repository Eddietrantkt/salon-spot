...
run('pnpm', ['--filter', '@salon-spot/api', 'test', '--runTestsByPath', 'test/availability.mysql.spec.ts', 'test/professional-identity.mysql.spec.ts', 'test/p1-http-bola.mysql.spec.ts', 'test/notifications.mysql.spec.ts', 'test/notifications-inbox.mysql.spec.ts', 'test/reviews.mysql.spec.ts'], env);
